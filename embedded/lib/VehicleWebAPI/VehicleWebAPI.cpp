/*
    VehicleWebAPI.cpp - Library for specific networkcommunication from vehicle to other objects in network.
...
void VehicleWebAPI::decideName() {
    ...
    if (ip == ipO) {
        ...
        if (DEBUGGER == true) Serial.print("ID: "); if (DEBUGGER == true) Serial.println(apiState.vehicleID);
    }
    else if (ip == ipI) {
...
void VehicleWebAPI::loop(ApiState *state) {
    ...
    if (DEBUGGER == true) Serial.print("Container api: "); if (DEBUGGER == true) Serial.println(apiState.container);
    if (DEBUGGER == true) Serial.print("port api: "); if (DEBUGGER == true) Serial.println(apiState.unloadPort);
    if (apiState.containerChange == true) {
        state->container        = apiState.container;
        apiState.containerChange = false;
    }
    
    if (DEBUGGER == true) Serial.print("task api: "); if (DEBUGGER == true) Serial.println(apiState.task);
...
void VehicleWebAPI::sendTask() {
    ...
    if  (client.connect(serverIP, SENDING_PORT)) {
        ...
        client.print(apiState.task);
        if (DEBUGGER == true) Serial.print("Task: "); if (DEBUGGER == true) Serial.println(apiState.task);
        client.print("&id=");
        client.print(apiState.vehicleID);
        client.println(" HTTP/1.1");
        client.println("Connection: close");
...
void VehicleWebAPI::sendTaskToObelix() {
    ...
    if  (client.connect(serverIP_Obelix, LISTEN_PORT)) {
        ...
        client.print(apiState.task);
        if (DEBUGGER == true) Serial.print("Task send obelix: "); if (DEBUGGER == true) Serial.println(apiState.task);
        client.println(" HTTP/1.1");
        client.println("Connection: close");
        client.println();
...
void VehicleWebAPI::sendTaskToIdefix() {
    ...
    if  (client.connect(serverIP_Idefix, LISTEN_PORT)) {
        ...
        client.print("GET /vTask?task=");
        client.print(apiState.task);
        if (DEBUGGER == true) Serial.print("Task send idefix: "); if (DEBUGGER == true) Serial.println(apiState.task);
        client.println(" HTTP/1.1");
        client.println("Connection: close");
        client.println();
...
void VehicleWebAPI::sendSector() {
    ...
    if  (client.connect(serverIP, SENDING_PORT)) {
        ...
        client.print(apiState.sector);
        if (DEBUGGER == true) Serial.print("Sector: "); if (DEBUGGER == true) Serial.println(apiState.sector);
        client.print("&id=");
        client.print(apiState.vehicleID);
        client.println(" HTTP/1.1");
        client.println("Connection: close");
...
void VehicleWebAPI::sendSectorToIdefix() {
    ...
    if  (client.connect(serverIP_Idefix, LISTEN_PORT)) {
        ...
        client.print(apiState.sector);
        if (DEBUGGER == true) Serial.print("Sector send to idefix: "); if (DEBUGGER == true) Serial.println(apiState.sector);
        client.println(" HTTP/1.1");
        client.println("Connection: close");
        client.println();
...
void VehicleWebAPI::sendSectorToObelix() {
    ...
    if  (client.connect(serverIP_Obelix, LISTEN_PORT)) {
        client.print("GET /vSector?sector=");
        client.print(apiState.sector);
        if (DEBUGGER == true) Serial.print("Sector send to obelix: "); if (DEBUGGER == true) Serial.println(apiState.sector);
        client.println(" HTTP/1.1");
        client.println("Connection: close");
        client.println();
...
String VehicleWebAPI::handleGET(String url, String params) {
    ...
    if (url == "/state") {
        ...
        if (DEBUGGER == true) Serial.print("Parameter: "); if (DEBUGGER == true) Serial.println(para);
        printJSONHeaders();
        ...
        if (DEBUGGER == true) Serial.print("Container request: "); if (DEBUGGER == true) Serial.println(apiState.container);
