...
// #define DEBUG_FUNCCALL  ///< Deefine DEBUG_FUNCCALL global to print all occuring functioncalls via serial
#endif
...
#define DBPOS(x) Serial.print(x)
#define DBPOSln(x) Serial.println(x)
#else
#define DBPOS(x)
#define DBPOSln(x)
#endif
